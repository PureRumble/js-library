...
var Testing = mods.get( "testing" ).Testing;
...
function( args )
{
	var streamParams = args.params;
	var branchingStreams = args.branches;
	var validate = args.validate;
	var prepare = args.prepare;
	var branch = args.branch;
	var serve = args.serve;
	var serveFailure = args.serveFailure;
	var serveErr = args.serveErr;
